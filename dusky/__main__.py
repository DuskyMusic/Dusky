"""
Copyright (c) 2022-2012 DuskyMusic
...
from dusky import (BOT_NAME, BOT_USERNAME, LOG_GROUP_ID,
                 aiohttpsession, app, app2)
from dusky.modules import ALL_MODULES
from dusky.adv import ADV_MODULES
from dusky.base import BASE_MODULES
from dusky.fun import FUN_MODULES
from dusky.utils import paginate_modules
from dusky.utils.dbfunctions import clean_restart_stage
from dusky import LOGGER
from dusky.utils.dbfunctions import  get_served_chats, get_served_users
from dusky.utils.dbfunctions import get_gbans_count,get_served_chats,get_served_users                    
import pytz
import datetime
    ...
    try:
        if restart_data:
            await app.edit_message_text(
                ...
                "**Dusky Restarted Successfully**",
            )

        else:
            await app.send_message(LOG_GROUP_ID, "Dusky started! Successfully")
    except Exception:
        pass
    try:
            await app2.join_chat("DuskysSupport")
            await app2.join_chat("DuskysUpdates")
...
start_button = InlineKeyboardMarkup(
    [
        ...
        [
           InlineKeyboardButton(
                text="sᴜᴘᴘᴏʀᴛ ", url="https://t.me/DuskysSupport"
            ),
            InlineKeyboardButton(
                text="ᴜᴘᴅᴀᴛᴇs", url="https://t.me/DuskysUpdates"
            ),
        ],
        [
            InlineKeyboardButton(
...
start_text = f"""
Hello There ! I'm **Dusky** [✨](https://telegra.ph/file/54719212c505f89953c39.jpg)
...
✘ Base commands are the basic tools of Dusky which help you to manage 
your group easily and effectivelyYou can choose 
an option below, by clicking a button.
Also you can ask anything in [Support Group](https://t.me/DuskysSupport).
...
✘ Extra tools which are available in Dusky and tools made for fun are here
...
started time - `2022 {dater}:{timer} `         
        ...
        return await message.reply(
            "**Heya, @DuskyXBot here :) PM me if you have any questions how to use me!**", reply_markup=keyboard
        )
...
keyboar = InlineKeyboardMarkup(
                [
                    ...
                    [
                        InlineKeyboardButton(
                            text="⚠️ ᴜᴘᴅᴀᴛᴇs", url="https://t.me/Duskyspdates"
                        ),
                        InlineKeyboardButton(
                            text="sᴜᴘᴘᴏʀᴛ ⚠️", url="https://t.me/DuskysSupport"
                        ),
                    ],
                    [
...
Dusky supports a large number of formatting options 
...
BTTON_1 = InlineKeyboardMarkup(
        ...
        [
        InlineKeyboardButton('Bug Report', url="https://t.me/DuskysSupport")
        ],
...
Use this to make Dusky feel a bit more customised! (only works in filters/notes)
...
async def commands_callbacc(_, CallbackQuery):
    ...
    TEXT_PART = f"""
@DuskyXBot ** is one of the fastest and most feature filled group manager**.   
 
 - **Latest Update Time** : `2022 {dater}:{timer}`
 - **Modules Loaded **:  `{modules_count}`
 - **Globally banned users.** :  `{gbans}`
@DuskyXBot **Mongo database stats**
 - ** Users ** : `{served_users}`
 - ** chats.** : `{served_chats}`
...
TEXT_PART_1 = """
**Welcome to the Dusky's Configuration**
The first thing to do is to add Dusky ✨ to your group! 
...
▫️ Add @DuskyXBot as Admin
▫️ Give full permissions 
▫️ Confirm
"""

TEXT_PART_3 = """
**Excellent!** Now Dusky is ready to use!
All commands can be used with / 
If you're facing any difficulties in setting up me in your group, 
so don't hesitate to come in @DuskysSupport.
...
BUTTON_1 = InlineKeyboardMarkup(
        [[        
        InlineKeyboardButton('Add Me To Your Group ! 🎉', url='http://t.me/DuskyXBot?startgroup=new')
        ],
...
Dusky✨ is developed and actively maintained by @OFFICIAL_DUSKY!

Dusky has been online since 2022/10/10 and have many [groups and users.](https://t.me/DuskysUpdates)
...
**Current Version:** `1.0.6` | [Special Credits](https://t.me/DuskysTeam)
"""
...
LOGGER.info(f"Owner: @OFFICIAL_DUSKY")
